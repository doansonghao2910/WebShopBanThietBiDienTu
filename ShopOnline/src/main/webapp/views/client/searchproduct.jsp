		...
		<div id="top-header"
			...
			<div class="container">
				<ul class="header-links pull-left">
					<li><a href="#"><i class="fa fa-phone"></i>0987057740</a></li>
					<li><a href="#"><i class="fa fa-envelope-o"></i>
							doansonghao2910@gmail.com</a></li>
					<li><a href="#"><i class="fa fa-map-marker"></i>Trực Mỹ -
							Trực Ninh - Nam Định </a></li>
				</ul>
					...
					<div class="col-md-6">
						<div class="header-search">
							<form action="searchproduct" method="get">
								...
								</select> <input class="input" name="name" placeholder="Nhập tên sản phẩm">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="section-title">
						<h3 class="title">Sản Phẩm Cần Tìm</h3>
							...
							<div id="tab1" class="tab-pane active">
								<div class="products-slick" data-nav="#slick-nav-1">
									<c:forEach items="${sessionScope.Products}" var="product">
										...
										<div class="product">
											<div class="product-img">
												<img src="${url}/img/${product.thumbnail}" alt="">
											...
											<div class="product-body">
												...
												<h4 class="product-price">
													${product.price}
													<del class="product-old-price">${product.discount}</del>
												</h4>
											...
											<div class="add-to-cart">
												<button class="add-to-cart-btn"
													onclick="window.location = 'add-to-cart?name=${sessionScope.username}&id=${product.id}&userid=${sessionScope.id}'">
