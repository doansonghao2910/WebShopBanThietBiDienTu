...
<%
  // (Integer)session.getAttribute("role_id") == 2
	if(session.getAttribute("username") == null){
		response.sendRedirect("/ShopOnline/views/admin/login.jsp");
	}
%>
<header id="header" class="header fixed-top d-flex align-items-center">
	...
	<div class="d-flex align-items-center justify-content-between">
		<a href="index.html" class="logo d-flex align-items-center"> <img
			...
			class="d-none d-lg-block">Admin Shop Electro</span>
			...
			<!-- End Profile Iamge Icon -->
				...
				<ul
					...
					<li class="dropdown-header">
						<h6><%= session.getAttribute("fullname") %></h6> <span> Người quản lý </span>
					</li>
					<li>
						<hr class="dropdown-divider">
					</li>
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="myProfile"> <i class="bi bi-person"></i> <span>Hồ
						sơ của tôi</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="users-profile.html"> <i class="bi bi-gear"></i> <span>Cài đặt
								tài khoản</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="pages-faq.html"> <i class="bi bi-question-circle"></i> <span>Bạn cần
								giúp đỡ ?</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
